...
namespace DX
{
	...
	public:
		...
		// appeler ceci pour éviter que la logique timestep fixe tente un ensemble d'appels de rattrapage 
		// Appels de Update.
		...
		void Tick(const TUpdate& update)
		{
			...
			// Convertissez les unités QPC dans un format de battement canonique. Dépassement de capacité impossible en raison de la limite précédente.
			...
			if (m_isFixedTimeStep)
			{
				...
				// d'accumulation dans le temps. Sans cette restriction, un jeu qui demandait 60 fps
